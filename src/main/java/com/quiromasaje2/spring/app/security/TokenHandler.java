package com.quiromasaje2.spring.app.security;
...
import com.quiromasaje2.spring.app.security.repository.UsuarioRepositoryImpl;
...
public class TokenHandler {
	...
	private UserDetailsService userDetailsService = new UsuarioService(new UsuarioRepositoryImpl());
